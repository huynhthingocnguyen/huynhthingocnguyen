...
namespace Ictshop.Areas.Admin.Controllers
{
        ...
        
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Maltc = new SelectList(db.Loaithucungs, "Maltc", "Tenltc");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Masp,Tensp,Giatien,Soluong,Mota,Anhbia,Mahang,Maltc")] Sanpham sanpham)
        {
            ...
            ViewBag.Maltc = new SelectList(db.Loaithucungs, "Maltc", "Tenltc", sanpham.Maltc);
            return View(sanpham);
        }
        ...
        public ActionResult Edit(int id)
        {
            ...
            var hdhselected = new SelectList(db.Loaithucungs, "Maltc", "Tenltc",dt.Maltc);
            ViewBag.Maltc = hdhselected;
           // 
            return View(dt);
        }
        ...
        public ActionResult Edit(Sanpham sanpham)
        {
            try
            {
                ...
                // Gán lại giá trị Mahang
                var hangselected = new SelectList(db.Hangsanxuats, "Mahang", "Tenhang", sanpham.Mahang);
                ViewBag.Mahang = hangselected;
                var hdhselected = new SelectList(db.Loaithucungs, "Maltc", "Tenltc", sanpham.Maltc);
                ViewBag.Maltc = hdhselected;

                oldItem.Mahang = sanpham.Mahang;
                oldItem.Maltc = sanpham.Maltc;
