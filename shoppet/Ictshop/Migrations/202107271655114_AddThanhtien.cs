    ...
    public partial class AddThanhtien : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Loaithucung", t => t.Maltc)
                .Index(t => t.Mahang)
                .Index(t => t.Maltc);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Maltc = c.Int(nullable: false, identity: true),
                        Tenltc = c.String(maxLength: 10, fixedLength: true),
                    })
                .PrimaryKey(t => t.Maltc);
        ...
        {
            DropForeignKey("dbo.Sanpham", "Maltc", "dbo.Loaithucung");
            ...
            DropIndex("dbo.Sanpham", new[] { "Maltc" });
